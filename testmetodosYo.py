...
def testOnOffTV():
    ...
    if ok == False:
        print("Hay un problema con el encendido o apagado del televisor")
...
def testEnlazarControl():
    ...
    if control.getTv() is None:
        print("Hay un error en el metodo enlazar y la asignacion del objeto televisor en el control")
...
def testCanal():
    ...
    if ok == False:
        print("Hay un problema con los metodos y restricciones del cambio de canales del televisor")
...
def testCanalEnlazar():
    ...
    if ok == False:
        print("Hay un problema con los metodos y restricciones del cambio de canales del televisor desde el control")
...
def testVolumen():
    ...
    if ok == False:
        print("Hay un problema con los metodos y restricciones del cambio de volumen del televisor")
